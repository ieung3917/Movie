			...
			<div class="padding-top padding-bottom">
				<div class="account-area">
					<div class="section-header-3">
						<span class="cate"><a href="index">timeMovie</a></span>
						<h2 class="title"><a href="index">정보등록</a></h2>
					</div>
					...
					<span id="bt"><input type="button" class="upload" onclick="bt1()" value="사진 업로드"></span>			 
						...
						<div class="form-group">
							<label for="이름">이름<span>*</span></label><input type="text"
								placeholder="Enter Your Name" id="memName" name="memName" >
						</div>
						<div class="form-group">
							<label for="생일">생일<span>*</span></label><input type="date"
								name="memBirth" >
						</div>
						<div class="form-group">
							<label for="휴대폰 번호">휴대폰 번호<span>*</span></label><input type="text"
								placeholder="Enter Your Phone Number" name="memPhone" onkeyup="checkId()" >
						</div>
						<div class="form-group checkgroup">
							<input type="checkbox" id="bal" required checked><label
								for="bal">개인정보 약관에 <a href="#0">동의합니다.
									</a> <a href="#0"></a></label>
						</div>
						<div class="form-group text-center">
							<input type="button" value="회원가입" onclick="checkConfirm()" value="가입">
						</div>
					</form>
					<div class="option">
						이미 아이디가 있으신가요? <a href="sign-in">로그인 페이지로</a>
					</div>				
				</div>
			</div>
		</div>
